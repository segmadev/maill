...
class RuleController extends Controller
{
    ...
    public function store(Request $request, $accountId): JsonResponse
    {
        ...
        try {
            ...
            $graphRule = $account->graph()
                ->post('/mailFolders/inbox/messageRules', [
    ...
    public function update(Request $request, $accountId, $ruleId): JsonResponse
    {
        ...
        try {
            ...
            if ($rule->outlook_rule_id) {
                ...
                $account->graph()
                    ->patch('/mailFolders/inbox/messageRules/' . $rule->outlook_rule_id, [
    ...
    public function destroy($accountId, $ruleId): JsonResponse
    {
        ...
        try {
            ...
            if ($rule->outlook_rule_id) {
                $account = $rule->account;
                $account->graph()
                    ->delete('/mailFolders/inbox/messageRules/' . $rule->outlook_rule_id);
            }
    ...
    public function syncWithOutlook($accountId): JsonResponse
    {
        ...
        try {
            ...
            $response = $account->graph()
                ->get('/mailFolders/inbox/messageRules');
    ...
    public function getFolders($accountId): JsonResponse
    {
        ...
        try {
            $response = $account->graph()->get('/mailFolders');
